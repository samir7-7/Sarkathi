...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="SarkarSathi Admin Dashboard — Real-time metrics, application reviews, and municipal service management."
    />
  ...
  <body class="bg-[#fafafc] text-slate-800">
    <div class="flex min-h-screen flex-col lg:flex-row">
      ...
      <aside
        id="sidebar"
        class="fixed inset-y-0 left-0 z-30 flex w-[220px] -translate-x-full flex-col border-r border-slate-200 bg-white transition-transform duration-300 lg:static lg:flex lg:translate-x-0"
      >
        <!-- Logo -->
        <div class="flex items-center justify-between px-5 pt-5 pb-2">
          <div class="flex items-center gap-1.5">
            <span class="text-xl font-bold tracking-tight text-brand-900"
              >SarkarSathi</span
            >
        ...
        <!-- Admin Portal Badge -->
        <div
          class="mx-5 mt-3 flex items-center gap-3 rounded-xl bg-brand-50 px-4 py-3"
        >
          <div
            class="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-brand-900 text-white"
          >
        ...
        <nav class="mt-6 flex-1 space-y-1 px-3">
          <a
            href="#"
            id="nav-applications"
            class="nav-link active flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm"
          >
          ...
          <a
            href="#"
            id="nav-services"
            class="nav-link flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-slate-600"
          >
        ...
        <div class="mt-auto border-t border-slate-100 px-3 pb-4 pt-3 space-y-2">
          ...
          <!-- System Alert -->
          <div
            class="alert-pulse mt-2 flex items-center gap-3 rounded-xl bg-slate-800 px-4 py-3 text-white"
          >
            <div
              class="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-blue-500/20"
            >
      ...
      <div class="flex-1 flex flex-col min-h-screen">
        <!-- Top Bar -->
        <header
          class="sticky top-0 z-20 flex items-center justify-between border-b border-slate-200 bg-white/80 backdrop-blur-md px-4 py-3.5 lg:px-8"
        >
          ...
          <div class="flex items-center gap-4">
            <button
              ...
              class="relative flex h-9 w-9 items-center justify-center rounded-lg text-slate-500 transition hover:bg-slate-100"
            >
            ...
            <button
              id="btn-profile"
              class="flex h-9 w-9 items-center justify-center overflow-hidden rounded-full bg-slate-800 text-white ring-2 ring-slate-200 ring-offset-2"
            >
        ...
        <!-- Page Content -->
        <main class="flex-1 px-4 py-6 md:px-8 md:py-8 overflow-y-auto">
          <!-- Page Header -->
          <div class="mb-8 fade-in">
            ...
            <p class="mt-1 text-sm text-slate-500">
              Real-time metrics and municipal service updates.
            </p>
          </div>
          ...
          >
            <!-- Total Applications -->
            <div
              class="stat-card rounded-2xl border border-slate-100 bg-white p-5 shadow-sm fade-in fade-in-delay-1"
            >
              ...
              <div class="mt-3 flex items-end gap-2">
                ...
                <span
                  class="mb-1 inline-flex items-center gap-0.5 rounded-full bg-green-50 px-2 py-0.5 text-[11px] font-semibold text-green-600"
                >
            ...
            <!-- Submitted -->
            <div
              class="stat-card rounded-2xl border border-slate-100 bg-white p-5 shadow-sm fade-in fade-in-delay-2"
            >
              <div class="flex items-center justify-between">
                <p
                  class="text-[11px] font-semibold uppercase tracking-wider text-slate-400"
            ...
            <!-- Under Review -->
            <div
              class="stat-card rounded-2xl border border-slate-100 bg-white p-5 shadow-sm fade-in fade-in-delay-3"
            >
              <div class="flex items-center justify-between">
                <p
                  class="text-[11px] font-semibold uppercase tracking-wider text-slate-400"
            ...
            <!-- Approved -->
            <div
              class="stat-card rounded-2xl border border-slate-100 bg-white p-5 shadow-sm fade-in fade-in-delay-4"
            >
              <div class="flex items-center justify-between">
                <p
                  class="text-[11px] font-semibold uppercase tracking-wider text-slate-400"
                ...
                <div
                  class="flex h-8 w-8 items-center justify-center rounded-lg bg-green-50 text-green-500"
                >
            ...
            <!-- Rejected -->
            <div
              class="stat-card rounded-2xl border border-slate-100 bg-white p-5 shadow-sm fade-in fade-in-delay-5"
            >
              <div class="flex items-center justify-between">
                <p
                  class="text-[11px] font-semibold uppercase tracking-wider text-slate-400"
          ...
          <div class="mb-8 grid gap-6 lg:grid-cols-[340px_1fr]">
            <!-- Quick Actions -->
            <div
              class="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm fade-in fade-in-delay-3"
            >
              ...
              <div class="mt-5 space-y-2">
                <a
                  href="#"
                  id="action-review"
                  class="quick-action flex items-center justify-between rounded-xl border border-slate-100 px-4 py-3.5"
                >
            ...
            <!-- Priority Reviews -->
            <div
              class="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm fade-in fade-in-delay-4"
            >
              <div class="flex items-center justify-between">
                ...
                <a
                  href="#"
                  class="text-sm font-semibold text-brand-500 transition hover:text-brand-900"
                  >View All</a
                >
              </div>
              ...
              <div class="mt-5 space-y-1" id="priority-reviews">
                ...
                <div
                  class="review-item flex items-center justify-between rounded-xl px-4 py-3.5"
                >
                  <div class="flex items-center gap-4">
                    <span class="h-2.5 w-2.5 rounded-full bg-red-500"></span>
                    <div>
                      <p class="text-sm font-semibold text-slate-800">
                        Building Permit &ndash; Commercial
                      </p>
                      <p class="mt-0.5 text-xs text-slate-400">
                        ID: BLD-2024-0891 &bull; 2 hrs ago
                      </p>
                    </div>
                  </div>
                  <button
                    class="rounded-lg bg-brand-900 px-4 py-1.5 text-xs font-semibold text-white shadow-sm transition hover:bg-brand-800"
                  >
                    Review
                  </button>
                </div>
                ...
                >
                  <div class="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p class="mt-0.5 text-xs text-slate-400">
                        ID: TRL-2024-1102 &bull; 4 hrs ago
                      </p>
                    </div>
                  </div>
                  <button
                ...
                >
                  <div class="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p class="mt-0.5 text-xs text-slate-400">
                        ID: WTR-2024-0054 &bull; 1 day ago
                      </p>
                    </div>
                  </div>
                  <button
          ...
          <div
            class="rounded-2xl border border-slate-100 bg-white shadow-sm fade-in fade-in-delay-5"
          >
              ...
              <table class="w-full text-left text-sm" id="activity-table">
                <thead>
                  <tr class="border-t border-b border-slate-100">
                    <th
                      class="whitespace-nowrap px-6 py-3 text-[11px] font-semibold uppercase tracking-wider text-slate-400"
                    >
                      Tracking ID
                    </th>
                    <th
                ...
                <tbody class="divide-y divide-slate-50" id="activity-body">
                  ...
                  <tr class="activity-row">
                    <td
                      class="whitespace-nowrap px-6 py-4 font-semibold text-brand-900"
                    >
                      #APP-8821
                    </td>
                  ...
                  <tr class="activity-row">
                    ...
                    <td class="whitespace-nowrap px-6 py-4">
                      <span
                        class="inline-flex rounded-full bg-cyan-50 px-3 py-1 text-xs font-semibold text-cyan-700"
                        >Assigned</span
                      >
                    </td>
                  </tr>
        ...
        <footer class="border-t border-slate-200 bg-white px-8 py-4">
          <div
            class="flex flex-col gap-3 text-[11px] font-medium text-slate-400 sm:flex-row sm:items-center sm:justify-between"
          >
            <p>
              &copy; 2024 SARKARSATHI MUNICIPAL AUTHORITY. SYSTEM STATUS:
            ...
            <div class="flex items-center gap-5">
              <a
                href="#"
                class="uppercase tracking-wide transition hover:text-brand-900"
                >Privacy Policy</a
              >
              <a
                href="#"
    ...
    <script>
      ...
      fetch("<%= request.getContextPath() %>/api/dashboard")
        ...
        .then((data) => {
          ...
          document.getElementById("stat-submitted").textContent = formatNumber(
            data.submitted,
          );
          document.getElementById("stat-review").textContent = formatNumber(
            data.review,
          );
          document.getElementById("stat-approved").textContent = formatNumber(
            data.approved,
          );
          document.getElementById("stat-rejected").textContent = formatNumber(
            data.rejected,
          );
      ...
      fetch("<%= request.getContextPath() %>/api/applications")
        ...
        .then((applications) => {
          ...
          recent.forEach((app) => {
            ...
            tr.innerHTML =
              '<td class="whitespace-nowrap px-6 py-4 font-semibold text-brand-900">#' +
              app.trackingId +
              "</td>" +
              '<td class="whitespace-nowrap px-6 py-4 text-slate-600">Service #' +
              app.serviceTypeId +
              "</td>" +
              '<td class="whitespace-nowrap px-6 py-4 text-slate-600">Citizen #' +
              app.citizenId +
              "</td>" +
              '<td class="whitespace-nowrap px-6 py-4 text-slate-500">' +
      ...
      document
        ...
        .addEventListener("input", function () {
          ...
          document
            .querySelectorAll("#activity-body .activity-row")
            .forEach((row) => {
