        ...
        <div class="flex min-h-screen flex-col">
            <main class="grid flex-1 lg:grid-cols-2">
                <section class="relative hidden overflow-hidden lg:flex">
                    <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=1600&auto=format&fit=crop" alt="City skyline" class="absolute inset-0 h-full w-full object-cover" >
                    <div class="absolute inset-0 bg-[#0f4ea8]/85">
                    </div>
                    <div class="absolute inset-0 bg-gradient-to-b from-[#0f4ea8]/55 via-[#0f4ea8]/60 to-[#062e69]/90">
                    </div>
                    <div class="relative flex h-full w-full flex-col justify-between px-12 py-16 text-white">
                        <div class="max-w-xl pt-12">
                            <a href="<%= request.getContextPath() %>" class="text-3xl font-bold tracking-tight text-white mb-8 block">
                                Sarkar<span class="text-blue-200">Sathi</span>
                            </a>
                ...
                <section class="flex items-center justify-center bg-[#f7f7fb] px-6 py-12 lg:px-12">
                    <div class="w-full max-w-md fade-in">
                        <div>
                            ...
                            <h2 class="mt-8 text-4xl font-bold tracking-tight text-[#0b3d86]">
                                SarkarSathi
                            </h2>
                        ...
                        <div class="mt-8 rounded-2xl bg-white px-6 py-8 shadow-[0_20px_60px_rgba(15,23,42,0.08)] sm:px-8">
                            ...
                            <!-- Role Toggle -->
                            <div class="mb-6">
                                <p class="mb-2 block text-xs font-semibold uppercase tracking-wider text-slate-800">
                                    Login As
                                </p>
                            ...
                            <form id="login-form" action="${pageContext.request.contextPath}/login" method="post" class="space-y-6">
                                ...
                                <div>
                                    <label for="email" class="mb-2 block text-xs font-semibold uppercase tracking-wider text-slate-800">
                                        Email Address
                                    </label>
                                    <input id="email" type="email" name="email" placeholder="name@example.com" value="<%= email %>" required class="w-full rounded-xl border border-slate-200 bg-[#f4f5fa] px-4 py-3 text-sm text-slate-800 outline-none transition focus:border-[#154a91] focus:ring-2 focus:ring-blue-100" >
                                </div>
                                <div>
                                    <div class="mb-2 flex items-center justify-between gap-4">
                                        <label for="password" class="block text-xs font-semibold uppercase tracking-wider text-slate-800">
                                            Password
                                        </label>
                                        <a href="#" class="text-xs font-semibold text-[#0b3d86] transition hover:text-[#154a91]">
                                            Forgot Password?
                                        </a>
                                    </div>
                                    <div class="relative">
                                        <input id="password" type="password" name="password" placeholder="Password" required class="w-full rounded-xl border border-slate-200 bg-[#f4f5fa] px-4 py-3 pr-16 text-sm text-slate-800 outline-none transition focus:border-[#154a91] focus:ring-2 focus:ring-blue-100" >
                                        <button type="button" class="password-toggle absolute right-3 top-1/2 -translate-y-1/2 text-xs font-semibold uppercase tracking-wider text-slate-500 transition hover:text-[#154a91]" data-target="password" aria-label="Show password" aria-pressed="false" >
                                            Show
                                        </button>
                                    </div>
                                </div>
                                <button type="submit" id="login-btn" class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#154a91] px-5 py-3 text-base font-semibold text-white shadow-md transition hover:bg-[#103b74] focus:outline-none focus:ring-2 focus:ring-blue-200 focus:ring-offset-1" >
                                    <span id="btn-text">
                                        Login to Dashboard
                                    </span>
                                    <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                            ...
                            <div id="register-link" class="mt-8 border-t border-slate-100 pt-6 text-center text-sm text-slate-600" <%= "admin".equalsIgnoreCase(userType) ? "style='display: none;'" : "" %>
                                ...
                                <a href="${pageContext.request.contextPath}/register.jsp" class="ml-1 font-semibold text-[#157a2f] transition hover:text-[#0f5d24]">
