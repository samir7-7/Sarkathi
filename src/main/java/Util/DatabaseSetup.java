    ...
    try {
      ...
      try (Connection connection = DriverManager.getConnection(urlWithoutDb, "root", "")) {
        ...
        try (Statement stmt = connection.createStatement()) {
          stmt.execute(
              "CREATE DATABASE IF NOT EXISTS SarkarSathi DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci");
      ...
      try (Connection connection = DriverManager.getConnection(
          "jdbc:mysql://localhost:3306/SarkarSathi", "root", "")) {
